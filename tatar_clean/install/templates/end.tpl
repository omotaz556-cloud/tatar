...
<div class="card" style="text-align:center;">
  ...
  <p style="color:#475569;">Thanks for installing Novaterra. Please remove the install folder.</p>
...
<div class="card">
  ...
  <div class="grid-2" style="gap:14px;">
    ...
    <div style="background:#f8fafc;border:1px solid #e5e7eb;border-radius:12px;padding:14px;">
      <b>⭐ Star on GitHub</b>
      <p style="margin:6px 0 0;color:#475569;font-size:14px;">If you like Novaterra, star the repo to support the project.</p>
    </div>
  </div>
