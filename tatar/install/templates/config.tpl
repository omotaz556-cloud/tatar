...
<div class="card">
  ...
  <div class="grid-2" style="margin-top:12px;">
    ...
    <div><label>Graphic pack</label><select class="input" name="gp_locate">
        <option value="gpack/novaterra_classic/" selected>Novaterra Default (classic T3.6 look)</option>
        <option value="gpack/novaterra_t4/">Novaterra T4 (T4-styled artwork)</option>
    </select></div>
