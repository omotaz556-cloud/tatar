...
tz_def('ADM_RAP_INTRO', 'تتيح للأدمن تحديد حسابين يدويًا في هذا العالم كـ"مرتبطين" (نفس المالك، نفس الجهاز، أو تأكد بأي طريقة أخرى أنهما لنفس الشخص). يُمنع النهب في الاتجاهين بين أي زوج مرتبط — تُحسم المعركة بشكل طبيعي، لكن بدون أي موارد منهوبة. هذا النظام مستقل عن كشف الحسابات المتعددة (الذي يكتفي بتقييم الأزواج المشبوهة للمراجعة اليدوية)، وعن العضويات التابعة (Feeding) التي تفعل العكس تمامًا (تلغي حد النهب بين الحسابات التي يوافق عليها اللاعب).');
tz_def('ADM_RAP_PRIORITY_NOTE', 'لو نفس الزوج معلن أيضًا كـ"مرتبط" في نظام العضويات التابعة (Feeding)، فإن هذه الحماية تكسب دائمًا: يُمنع النهب بينهما بغض النظر عن أي إعدادات فيدينج لهذا الزوج.');
...
tz_def('ADMIN_EDIT_SITTERS', 'تعديل مدراء الحساب');
