...
Novaterra 4-style hero system ported into the T3.6 engine, in phases:
...
Novaterra 4-style alliance system ported into the T3.6 engine, in phases:
...
* NEW gpack novaterra_t4 style buildings
* Alliance rank and privilege management added.
* Main Building instant demolition with 10 gold.
* Account Statement added in Novaterra Plus section (received/spent gold history).
...
Thanks to the original and current maintainers, contributors, testers, and the Novaterra community.
