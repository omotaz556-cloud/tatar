...
<head>
	...
	<script type="text/javascript">
		Novaterra.Translation.add({'allgemein.cancel': 'Abbrechen','allgemein.ok': 'OK','allgemein.send': 'com'});
	</script>
</head>
<body class="webkit chrome">
	...
	<div id="background">
		<div id="content-container">
			...
			<div id="header">
				<img src="img/x.gif" id="brand" alt="Novaterra"/> <?php echo $lang['notification']['awaits_you']; ?></div>
			...
			<div id="senden-container">
				...
				<div id="screensNav-container">
					<div class="but_div_active" id="but_div_0" onmouseover="Novaterra.Notification.screenNav(0);" onmouseout="Novaterra.Notification.contslide();"></div>
					<div class="but_div" id="but_div_1" onmouseover="Novaterra.Notification.screenNav(1);" onmouseout="Novaterra.Notification.contslide();"></div>
					<div class="but_div" id="but_div_2" onmouseover="Novaterra.Notification.screenNav(2);" onmouseout="Novaterra.Notification.contslide();"></div>
					<div class="but_div" id="but_div_3" onmouseover="Novaterra.Notification.screenNav(3);" onmouseout="Novaterra.Notification.contslide();"></div>
					<div class="but_div" id="but_div_4" onmouseover="Novaterra.Notification.screenNav(4);" onmouseout="Novaterra.Notification.contslide();"></div>
				</div>
			</div>
			...
			<script type="text/javascript">
				...
				{
							Novaterra.Notification.screenTitel = new Array();
					Novaterra.Notification.screenTitel[0] = "<?php echo $lang['notification']['title1']; ?>";
					Novaterra.Notification.screenTitel[1] = "<?php echo $lang['notification']['title2']; ?>";
					Novaterra.Notification.screenTitel[2] = "<?php echo $lang['notification']['title3']; ?>";
					Novaterra.Notification.screenTitel[3] = "<?php echo $lang['notification']['title4']; ?>";
					Novaterra.Notification.screenTitel[4] = "<?php echo $lang['notification']['title5']; ?>";

							Novaterra.Notification.screenText = new Array();
					Novaterra.Notification.screenText[0] = "<?php echo $lang['notification']['desc1']; ?>";
					Novaterra.Notification.screenText[1] = "<?php echo $lang['notification']['desc2']; ?>";
					Novaterra.Notification.screenText[2] = "<?php echo $lang['notification']['desc3']; ?>";
					Novaterra.Notification.screenText[3] = "<?php echo $lang['notification']['desc4']; ?>";
					Novaterra.Notification.screenText[4] = "<?php echo $lang['notification']['desc5']; ?>";

					Novaterra.Notification.screenInit();
				});
			</script>
		</div>
