...
//COPYRIGHT
tz_def('TRAVIAN_COPYRIGHT', 'Novaterra — Clone de Novaterra 100 % open source.');
...
tz_def('ONE_DAY_OF_TRAVIAN', '1 jour Novaterra ');
tz_def('TWO_DAYS_OF_TRAVIAN', '2 jours Novaterra ');
...
Au final, nous verrons si les tribus libres de Novaterra pourront une fois de plus déjouer les Natars et les vaincre une fois pour toutes. Ne soyez pas assez fou pour croire que les Natars partiront sans combattre !
...
tz_def('TZ_FEATURES_OF_TRAVIAN', 'Fonctionnalités de Novaterra');
...
tz_def('TZ_ADDITIONALLY_THE_TRAVIAN_TEAM_WILL', 'De plus, l\'équipe Novaterra ne fournira d\'informations concernant les bannissements à aucune personne autre que le propriétaire du compte.');
...
tz_def('TZ_HERE_YOU_CAN_CHANGE_TRAVIAN_S_DISP', 'Ici vous pouvez modifier l\'heure affichée de Novaterra pour l\'adapter à votre fuseau horaire.');
...
tz_def('TZ_IN_ORDER_TO_PLAY_TRAVIAN_YOU_NEED', 'Pour jouer à Novaterra, vous avez besoin d\'une adresse e-mail valide à laquelle le code d\'activation peut être envoyé. Dans des cas exceptionnels, cet e-mail peut ne pas arriver.');
...
tz_def('TZ_IN_TRAVIAN_YOU_ARE_NOT_ALONE_YOU_I', 'Dans Novaterra, vous n\'êtes pas seul ; vous interagissez avec des milliers d\'autres joueurs dans le monde de Novaterra.');
...
tz_def('TZ_THE_TRAVIAN_TEAM_RESERVES_THE_RIGH', 'L\'équipe Novaterra se réserve le droit de modifier les règles à tout moment.');
...
tz_def('ADM_YES', 'Oui');
tz_def('ADM_NO', 'Non');
tz_def('ADM_TRAVIAN_OFFICIAL', 'Novaterra officiel');
...
tz_def('ADM_ACTIVATE_TRAVIAN_PLUS_FOR_ALL_PLAYERS_ON_THE', 'Activer Novaterra Plus pour TOUS les joueurs du serveur.');
...
tz_def('ADM_THIS_ACTION_WILL_DISABLE_TRAVIAN_PLUS_FOR_AL', 'Cette action désactivera Novaterra Plus pour TOUS les joueurs.');
