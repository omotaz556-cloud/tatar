...
tz_def('TRAVIAN_PLUS', 'Novaterra <b><span class="plus_g">P</span><span class="plus_o">l</span><span class="plus_g">u</span><span class="plus_o">s</span></span></span></b>');
...
//COPYRIGHT
tz_def('TRAVIAN_COPYRIGHT', 'Novaterra 100% Open Source Novaterra Clone.');
...
tz_def('ONE_DAY_OF_TRAVIAN', '1 día de Novaterra ');
tz_def('TWO_DAYS_OF_TRAVIAN', '2 días de Novaterra ');
...
Many moons ago the tribes of Novaterra were surprised by the unforeseen return of the Natars. This tribe from immemorial times surpassing all in wisdom, might and glory was about to trouble the free ones again. Thus they put all their efforts in preparing a last war against the Natars and vanquishing them forever. Many thought about the so-called "Wonders of the World", a construction of many legends, as the only solution. It was told that it would render anyone invincible once completed. Ultimately making the constructors the rulers and conquerors of all known Novaterra. 
...
Today, however, this last secret will be revealed. Deprivations and endeavors of the past will not have been in vain, as today scouts of several tribes have successfully obtained the whereabouts of the construction plans. Well guarded by the Natars, they lie hidden in several oases to be found all over Novaterra. Only the most valiant heroes will be able to secure such a plan and bring it home safely so that the construction can begin. 

In the end, we will see whether the free tribes of Novaterra can once again outwit the Natars and vanquish them once and for all. Do not be so foolish as to assume that the Natars will leave without a fight, though!
...
tz_def('TZ_FEATURES_OF_TRAVIAN', 'Features of Novaterra');
...
tz_def('TZ_TRAVIAN', 'Novaterra');
tz_def('TZ_TRAVIANX', 'TravianX');
tz_def('TZ_NOVATERRA', 'Novaterra');
tz_def('TZ_TRAVIAN_GAMES', 'Novaterra');
...
tz_def('TZ_TRAVIAN_DEFAULT', 'Novaterra Default');
tz_def('TZ_TRAVIAN_GOLD_CLUB', 'Novaterra Gold Club');
tz_def('TZ_TRAVIAN_T4_STYLE', 'Novaterra T4 Style');
...
tz_def('TZ_ADDITIONALLY_THE_TRAVIAN_TEAM_WILL', 'Additionally, the Novaterra Team will not provide information concerning bans to any person, other than the account owner.');
...
tz_def('TZ_HERE_YOU_CAN_CHANGE_TRAVIAN_S_DISP', 'Here you can change Novaterra\'s displayed time to fit your time zone.');
...
tz_def('TZ_IN_ORDER_TO_PLAY_TRAVIAN_YOU_NEED', 'In order to play Novaterra you need a valid email address to which the activation code can be send. There are exceptional cases when this email might not arrive.');
...
tz_def('TZ_IN_TRAVIAN_YOU_ARE_NOT_ALONE_YOU_I', 'In Novaterra you are not alone; you interact with thousands of other players in the Novaterra world.');
...
tz_def('TZ_THE_TRAVIAN_TEAM_RESERVES_THE_RIGH', 'The Novaterra Team reserves the right to change the rules at any time.');
...
tz_def('ADM_YES', 'Yes');
tz_def('ADM_NO', 'No');
tz_def('ADM_TRAVIAN_OFFICIAL', 'Novaterra Official');
...
tz_def('ADM_ACTIVATE_TRAVIAN_PLUS_FOR_ALL_PLAYERS_ON_THE', 'Activate Novaterra Plus for ALL players on the server.');
...
tz_def('ADM_THIS_ACTION_WILL_DISABLE_TRAVIAN_PLUS_FOR_AL', 'This action will disable Novaterra Plus for ALL players.');
