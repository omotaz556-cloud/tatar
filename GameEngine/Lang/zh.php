...
//COPYRIGHT
tz_def('TRAVIAN_COPYRIGHT', 'Novaterra 100% 开源 Novaterra 克隆。');
...
tz_def('TZ_EVENT', '事件');
tz_def('TZ_FEATURES_OF_TRAVIAN', 'Novaterra 的功能');
...
tz_def('TZ_ADDITIONALLY_THE_TRAVIAN_TEAM_WILL', '此外，Novaterra 团队不会向账户所有者以外的任何人提供有关封禁的信息。');
...
tz_def('TZ_HERE_YOU_CAN_CHANGE_TRAVIAN_S_DISP', '您可以在此更改 Novaterra 显示的时间以符合您的时区。');
...
tz_def('TZ_IN_ORDER_TO_PLAY_TRAVIAN_YOU_NEED', '要游玩 Novaterra，您需要一个有效的电子邮件地址以接收激活码。在特殊情况下，此邮件可能无法送达。');
...
tz_def('TZ_IN_TRAVIAN_YOU_ARE_NOT_ALONE_YOU_I', '在 Novaterra 中您并不孤单；您会与 Novaterra 世界中成千上万的其他玩家互动。');
...
tz_def('TZ_THE_TRAVIAN_TEAM_RESERVES_THE_RIGH', 'Novaterra 团队保留随时更改规则的权利。');
