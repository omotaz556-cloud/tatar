...
//COPYRIGHT
tz_def("TRAVIAN_COPYRIGHT","Novaterra - Clone di Novaterra 100% Open Source.");
...
Alla fine, vedremo se le tribù libere di Novaterra potranno ancora una volta superare in astuzia i Natar e sconfiggerli una volta per tutte. Non essere così sciocco da presumere che i Natar se ne andranno senza combattere!
...
tz_def('TZ_FEATURES_OF_TRAVIAN', 'Caratteristiche di Novaterra');
...
tz_def('TZ_ADDITIONALLY_THE_TRAVIAN_TEAM_WILL', 'Inoltre, il team Novaterra non fornirà informazioni sui ban a nessuno, tranne al proprietario dell\'account.');
...
tz_def('TZ_HERE_YOU_CAN_CHANGE_TRAVIAN_S_DISP', 'Qui puoi cambiare l\'ora visualizzata di Novaterra per adattarla al tuo fuso orario.');
...
tz_def('TZ_IN_ORDER_TO_PLAY_TRAVIAN_YOU_NEED', 'Per giocare a Novaterra ti serve un indirizzo e-mail valido a cui inviare il codice di attivazione. In casi eccezionali questa e-mail potrebbe non arrivare.');
...
tz_def('TZ_IN_TRAVIAN_YOU_ARE_NOT_ALONE_YOU_I', 'In Novaterra non sei solo; interagisci con migliaia di altri giocatori nel mondo di Novaterra.');
...
tz_def('TZ_THE_TRAVIAN_TEAM_RESERVES_THE_RIGH', 'Il team Novaterra si riserva il diritto di modificare le regole in qualsiasi momento.');
