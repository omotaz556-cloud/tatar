...
//COPYRIGHT
tz_def('TRAVIAN_COPYRIGHT', 'Novaterra 100% Clonă Novaterra Open Source.');
...
tz_def('ONE_DAY_OF_TRAVIAN', '1 zi Novaterra Plus ');
tz_def('TWO_DAYS_OF_TRAVIAN', '2 zile Novaterra Plus ');
...
Cu multe luni în urmă triburile din Novaterra au fost surprinse de întoarcerea neașteptată a Natarilor. Acest trib din timpuri imemoriale, care îi depășește pe toți în înțelepciune, putere și glorie, era pe cale să tulbure din nou pe cei liberi. Astfel și-au pus toate eforturile în pregătirea unui ultim război împotriva Natarilor și în înfrângerea lor pentru totdeauna. Mulți s-au gândit la așa-numitele "Minuni ale Lumii", o construcție din multe legende, ca singura soluție. Se spunea că odată finalizată ar face pe oricine invincibil. În cele din urmă făcând constructorii conducători și cuceritori ai întregului Novaterra cunoscut.
...
În cele din urmă, vom vedea dacă triburile libere din Novaterra pot din nou să-i depășească pe Natari și să-i învingă odată pentru totdeauna. Nu fi atât de prost încât să presupui că Natarii vor pleca fără luptă, totuși!
...
tz_def('TZ_FEATURES_OF_TRAVIAN', 'Caracteristicile Novaterra');
...
tz_def('TZ_ADDITIONALLY_THE_TRAVIAN_TEAM_WILL', 'În plus, echipa Novaterra nu va furniza informații despre interdicții niciunei persoane, în afară de proprietarul contului.');
...
tz_def('TZ_HERE_YOU_CAN_CHANGE_TRAVIAN_S_DISP', 'Aici poți schimba ora afișată de Novaterra pentru a se potrivi cu fusul tău orar.');
...
tz_def('TZ_IN_ORDER_TO_PLAY_TRAVIAN_YOU_NEED', 'Pentru a juca Novaterra ai nevoie de o adresă de e-mail validă la care poate fi trimis codul de activare. Există cazuri excepționale în care acest e-mail ar putea să nu ajungă.');
...
tz_def('TZ_IN_TRAVIAN_YOU_ARE_NOT_ALONE_YOU_I', 'În Novaterra nu ești singur; interacționezi cu mii de alți jucători în lumea Novaterra.');
...
tz_def('TZ_THE_TRAVIAN_TEAM_RESERVES_THE_RIGH', 'Echipa Novaterra își rezervă dreptul de a modifica regulile în orice moment.');
...
tz_def('ADM_YES', 'Da');
tz_def('ADM_NO', 'Nu');
tz_def('ADM_TRAVIAN_OFFICIAL', 'Novaterra oficial');
...
tz_def('ADM_ACTIVATE_TRAVIAN_PLUS_FOR_ALL_PLAYERS_ON_THE', 'Activeaza Novaterra Plus pentru TOTI jucatorii de pe server.');
...
tz_def('ADM_THIS_ACTION_WILL_DISABLE_TRAVIAN_PLUS_FOR_AL', 'Aceasta actiune va dezactiva Novaterra Plus pentru TOTI jucatorii.');
