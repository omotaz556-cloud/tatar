...
document.addEventListener('DOMContentLoaded',function(){
  ...
  h.innerHTML = `
    ...
    <div><h1>Novaterra Installation</h1><p>Setup wizard • v.11.0 Full Refactor&Redesign</p></div>
  `;
  ...
  f.innerHTML = `<div>© 2010 - 2026 Novaterra • All rights reserved</div><div>Server running on <b>v.10.0 Full Refactor&Redesign</b></div>`;
