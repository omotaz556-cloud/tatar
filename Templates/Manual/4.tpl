...
<li><a href="anleitung.php?s=3" target="_blank"><?php echo MANUAL_FAQ; ?> <img class="external" src="img/x.gif" alt="<?php echo NEW_WINDOW; ?>" title="<?php echo NEW_WINDOW; ?>" /></a><br><?php echo MANUAL_FAQ_DESC; ?> <a href="http://novaterra.wikia.com/wiki/Travian_Wiki" target=blank>Fandom Novaterra Wiki</a>.</li>
</ul>
<map id="nav" name="nav">
