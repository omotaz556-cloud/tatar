...
<li><a href="anleitung.php?s=3" target="_blank">Novaterra FAQ <img class="external" src="img/x.gif" alt="new window" title="new window" /></a><br>This ingame help just gives you brief information. More information is available at the <a href="http://novaterra.wikia.com/wiki/Travian_Wiki" target=blank>Fandom Novaterra Wiki</a>.</li>
</ul>
<map id="nav" name="nav">
